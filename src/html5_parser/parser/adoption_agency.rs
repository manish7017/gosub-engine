        ...
        loop {
            ...
            loop {
                ...
                let idx = self
                    ...
                    .position(|elem| elem == &ActiveElement::Node(node_id))
                    .expect("node not found");
                self.active_formatting_elements[idx] = ActiveElement::Node(replacement_node_id);
                let idx = self
                    .open_elements
                    .iter()
                ...
                // Step 4.13.7
                if last_node_idx_oe == furthest_block_idx_oe {
                    bookmark_afe = idx + 1;
                }
            ...
            self.open_elements
                .insert(furthest_block_idx_oe, new_element_id);
        }
    }
